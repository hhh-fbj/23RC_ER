...
void AIMU_Data_Classdef::mpu_offset_call()
{
  ...
  xyz[Offset_a][IMU_X] = xyz[Offset_a][IMU_X] / 600;
  xyz[Offset_a][IMU_Y] = xyz[Offset_a][IMU_Y] / 600;
  xyz[Offset_a][IMU_Z] = xyz[Offset_a][IMU_Z] / 600;
  xyz[Offset_g][IMU_X] = xyz[Offset_g][IMU_X] / 600;
  xyz[Offset_g][IMU_Y] = xyz[Offset_g][IMU_Y] / 600;
  xyz[Offset_g][IMU_Z] = xyz[Offset_g][IMU_Z] / 600;
