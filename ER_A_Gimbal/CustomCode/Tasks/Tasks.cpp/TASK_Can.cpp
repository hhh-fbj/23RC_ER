    ...
    for(;;)
    {
        ...
        switch(CAN1_Rx.Header.StdId)
        {
            ...
            break;
						...
						case 0x201:
                Shoot.Shoot_Motor.update(CAN1_Rx.Data);
                DevicesMonitor.Update(Frame_SHOOT_MOTOR);
            break;

             case 0x202:
                Shoot.LeftPull_Motor.update(CAN1_Rx.Data);
...
void Task_CAN2_Receive(void *argument)
{
    ...
    for(;;)
    {
        ...
        switch(CAN2_Rx.Header.StdId)
        {
            ...
            case 0x201:
                Clamp.Stretch_Motor.update(CAN2_Rx.Data);
                DevicesMonitor.Update(Frame_STRETCH_MOTOR);
            break;

             case 0x202:
                Clamp.Lift_Motor.update(CAN2_Rx.Data);
                DevicesMonitor.Update(Frame_LIFT_MOTOR);
            break;

             case 0x203:
                Clamp.PickPlace_Motor.update(CAN2_Rx.Data);
