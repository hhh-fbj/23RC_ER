...
{
	uint32_t KeyMouse = (uint32_t)DataPack.key | DataPack.Mouse_keyL << 16 | DataPack.Mouse_keyR << 17;// 把键盘鼠标的标志位合并。
 ...
 * @return     Get后面的数据的值
 */
uint64_t DR16_Classdef::Get_CH0(void)
{
    return DataPack.CH0;
}

uint64_t DR16_Classdef::Get_CH1(void)
{
    return DataPack.CH1;
}

uint64_t DR16_Classdef::Get_CH2(void)
{
    return DataPack.CH2;
}

uint64_t DR16_Classdef::Get_CH3(void)
{
    return DataPack.CH3;
}

uint64_t DR16_Classdef::Get_CH4(void)
{
    return DataPack.CH4;
}

SW_Status_Typedef DR16_Classdef::Get_S1_L(void)
{
    return (SW_Status_Typedef)DataPack.S1_L;
}

SW_Status_Typedef DR16_Classdef::Get_S2_R(void)
{
 ...
 */
bool DR16_Classdef::IsKeyPress(KeyList_e KeyMouse, KeyPress_Type_e Action)
{
   uint8_t action = 0;
	switch (Action)
	{
